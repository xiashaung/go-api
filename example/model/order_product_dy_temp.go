...
CREATE TABLE `order_product_dy_temp` (
  ...
  `anchor_open_id` bigint(20) NOT NULL DEFAULT '0' COMMENT '主播open_id',
...
JSON Sample
-------------------------------------
{    "id": 14,    "order_id": 74,    "suborder_id": 90,    "shop_id": 98,    "talent_id": 32,    "anchor_id": 21,    "seller_id": 54,    "anchor_open_id": 12,    "suborder_status": 67,    "commission_rate": 95,    "estimated_commission": 58,    "real_commission": 89,    "open_id": "QlnaBLvlmERHuoxLWbCWWZUuY",    "biz": 79,    "order_type": 47,    "trade_type": 62,    "pre_sale_type": 81,    "process_type": 78,    "pay_type": 14,    "pay_time": 56,    "finish_time": 17,    "create_time": 82,    "cancel_reason": "TgDEAXSlPJCOsFcmHscoNxpnA",    "send_pay": 54,    "author_name": "KKyMfddJZCZEEMEADsXHPatCt",    "theme_type": "pWsHfrnAVXfDyxIkqyourjlLR",    "app_id": 70,    "room_id": 88,    "channel_payment_no": "yCdyuDksfWrMHnhrlsoqKFKVg",    "order_amount": 21,    "pay_amount": 25,    "post_amount": 96,    "post_insurance_amount": 99,    "ship_time": 34,    "logistics_receipt_time": 95,    "confirm_receipt_time": 40,    "promotion_amount": 88,    "promotion_detail": "OcXZGfivdgUUnlDbotXaDbdfL",    "logistics_info": "llSspJAAhMuKHXwSctJGJWKej",    "yx_product_id": 88,    "product_id": 74,    "product_name": "EsYKyZaUCVlOriunmlvnCAbRS",    "product_pic": "VUVKLibWLxxTGuMEeJfscHMfv",    "sku_id": 8,    "spec": "ieBxjPjXLBkFZOwXIcBsmYHAO",    "category_list": "gNWmFfVVuTjIjqNhIDPUaEEJX",    "origin_amount": 21,    "item_num": 90,    "is_comment": 20,    "add_time": 78,    "last_time": 49}
...
// OrderProductDyTemp struct is a row record of the order_product_dy_temp table in the yx database
type OrderProductDyTemp struct {
	...
	//[ 4] talent_id                                      ubigint              null: false  primary: false  isArray: false  auto: false  col: ubigint         len: -1      default: [0]
	TalentID uint64 `gorm:"column:talent_id;type:ubigint;default:0;" json:"talent_id"` // 达人id
	//[ 5] anchor_id                                      bigint               null: false  primary: false  isArray: false  auto: false  col: bigint          len: -1      default: [0]
	AnchorID int64 `gorm:"column:anchor_id;type:bigint;default:0;" json:"anchor_id"` // 主播id
	//[ 6] seller_id                                      int                  null: false  primary: false  isArray: false  auto: false  col: int             len: -1      default: [0]
	SellerID int32 `gorm:"column:seller_id;type:int;default:0;" json:"seller_id"` // 卖家id
	//[ 7] anchor_open_id                                 bigint               null: false  primary: false  isArray: false  auto: false  col: bigint          len: -1      default: [0]
	AnchorOpenID int64 `gorm:"column:anchor_open_id;type:bigint;default:0;" json:"anchor_open_id"` // 主播open_id
	//[ 8] suborder_status                                int                  null: false  primary: false  isArray: false  auto: false  col: int             len: -1      default: [0]
	SuborderStatus int32 `gorm:"column:suborder_status;type:int;default:0;" json:"suborder_status"` // 子订单状态
	//[ 9] commission_rate                                int                  null: false  primary: false  isArray: false  auto: false  col: int             len: -1      default: [0]
	CommissionRate int32 `gorm:"column:commission_rate;type:int;default:0;" json:"commission_rate"` // 佣金率
	//[10] estimated_commission                           int                  null: false  primary: false  isArray: false  auto: false  col: int             len: -1      default: [0]
	EstimatedCommission int32 `gorm:"column:estimated_commission;type:int;default:0;" json:"estimated_commission"` // 预估佣金
	//[11] real_commission                                int                  null: false  primary: false  isArray: false  auto: false  col: int             len: -1      default: [0]
	RealCommission int32 `gorm:"column:real_commission;type:int;default:0;" json:"real_commission"` // 真实佣金
	//[12] open_id                                        varchar(64)          null: false  primary: false  isArray: false  auto: false  col: varchar         len: 64      default: []
	OpenID string `gorm:"column:open_id;type:varchar;size:64;" json:"open_id"` // 在抖音小程序下单时，买家的抖音小程序ID
	//[13] biz                                            smallint             null: false  primary: false  isArray: false  auto: false  col: smallint        len: -1      default: [0]
	Biz int32 `gorm:"column:biz;type:smallint;default:0;" json:"biz"` // 业务来源：1-鲁班 2-小店 3-好好学习等
	//[14] order_type                                     int                  null: false  primary: false  isArray: false  auto: false  col: int             len: -1      default: [0]
	OrderType int32 `gorm:"column:order_type;type:int;default:0;" json:"order_type"` // 订单类型 (0实物，2普通虚拟，4poi核销，5三方核销，6服务市场)
	//[15] trade_type                                     usmallint            null: false  primary: false  isArray: false  auto: false  col: usmallint       len: -1      default: [0]
	TradeType uint32 `gorm:"column:trade_type;type:usmallint;default:0;" json:"trade_type"` // 交易类型：1-拼团 2-定金预售
	//[16] pre_sale_type                                  usmallint            null: false  primary: false  isArray: false  auto: false  col: usmallint       len: -1      default: [0]
	PreSaleType uint32 `gorm:"column:pre_sale_type;type:usmallint;default:0;" json:"pre_sale_type"` // 预售类型 ，0 现货类型，1 全款预售 2 阶梯发货
	//[17] process_type                                   usmallint            null: false  primary: false  isArray: false  auto: false  col: usmallint       len: -1      default: [0]
	...
	//[18] pay_type                                       uint                 null: false  primary: false  isArray: false  auto: false  col: uint            len: -1      default: [0]
	PayType uint32 `gorm:"column:pay_type;type:uint;default:0;" json:"pay_type"` // 支付类型 (0：货到付款，1：微信，2：支付宝）
	//[19] pay_time                                       int                  null: false  primary: false  isArray: false  auto: false  col: int             len: -1      default: [0]
	PayTime int32 `gorm:"column:pay_time;type:int;default:0;" json:"pay_time"` // 支付时间 (pay_type为0货到付款时, 此字段为空)
	//[20] finish_time                                    int                  null: false  primary: false  isArray: false  auto: false  col: int             len: -1      default: [0]
	FinishTime int32 `gorm:"column:finish_time;type:int;default:0;" json:"finish_time"` // 订单完成时间\n
	//[21] create_time                                    int                  null: false  primary: false  isArray: false  auto: false  col: int             len: -1      default: [0]
	CreateTime int32 `gorm:"column:create_time;type:int;default:0;" json:"create_time"` // 下单时间
	//[22] cancel_reason                                  varchar(255)         null: false  primary: false  isArray: false  auto: false  col: varchar         len: 255     default: []
	CancelReason string `gorm:"column:cancel_reason;type:varchar;size:255;" json:"cancel_reason"` // 取消原因
	//[23] send_pay                                       smallint             null: false  primary: false  isArray: false  auto: false  col: smallint        len: -1      default: [0]
	...
	//[24] author_name                                    varchar(32)          null: false  primary: false  isArray: false  auto: false  col: varchar         len: 32      default: []
	AuthorName string `gorm:"column:author_name;type:varchar;size:32;" json:"author_name"` // 直播主播名称
	//[25] theme_type                                     varchar(10)          null: false  primary: false  isArray: false  auto: false  col: varchar         len: 10      default: []
	ThemeType string `gorm:"column:theme_type;type:varchar;size:10;" json:"theme_type"` // 下单来源：1-直播间 2-短视频 3-文章
	//[26] app_id                                         bigint               null: false  primary: false  isArray: false  auto: false  col: bigint          len: -1      default: [0]
	AppID int64 `gorm:"column:app_id;type:bigint;default:0;" json:"app_id"` // 小程序id
	//[27] room_id                                        bigint               null: false  primary: false  isArray: false  auto: false  col: bigint          len: -1      default: [0]
	RoomID int64 `gorm:"column:room_id;type:bigint;default:0;" json:"room_id"` // 直播间id
	//[28] channel_payment_no                             varchar(32)          null: false  primary: false  isArray: false  auto: false  col: varchar         len: 32      default: []
	ChannelPaymentNo string `gorm:"column:channel_payment_no;type:varchar;size:32;" json:"channel_payment_no"` // 支付流水号
	//[29] order_amount                                   int                  null: false  primary: false  isArray: false  auto: false  col: int             len: -1      default: [0]
	OrderAmount int32 `gorm:"column:order_amount;type:int;default:0;" json:"order_amount"` // 订单金额（分）
	//[30] pay_amount                                     int                  null: false  primary: false  isArray: false  auto: false  col: int             len: -1      default: [0]
	PayAmount int32 `gorm:"column:pay_amount;type:int;default:0;" json:"pay_amount"` // 支付金额（分）
	//[31] post_amount                                    int                  null: false  primary: false  isArray: false  auto: false  col: int             len: -1      default: [0]
	PostAmount int32 `gorm:"column:post_amount;type:int;default:0;" json:"post_amount"` // 运费，单位分
	//[32] post_insurance_amount                          int                  null: false  primary: false  isArray: false  auto: false  col: int             len: -1      default: [0]
	PostInsuranceAmount int32 `gorm:"column:post_insurance_amount;type:int;default:0;" json:"post_insurance_amount"` // 运费险金额\n
	//[33] ship_time                                      int                  null: false  primary: false  isArray: false  auto: false  col: int             len: -1      default: [0]
	ShipTime int32 `gorm:"column:ship_time;type:int;default:0;" json:"ship_time"` // 发货时间
	//[34] logistics_receipt_time                         int                  null: false  primary: false  isArray: false  auto: false  col: int             len: -1      default: [0]
	LogisticsReceiptTime int32 `gorm:"column:logistics_receipt_time;type:int;default:0;" json:"logistics_receipt_time"` // 物流收货时间
	//[35] confirm_receipt_time                           int                  null: false  primary: false  isArray: false  auto: false  col: int             len: -1      default: [0]
	ConfirmReceiptTime int32 `gorm:"column:confirm_receipt_time;type:int;default:0;" json:"confirm_receipt_time"` // 用户确认收货时间
	//[36] promotion_amount                               int                  null: false  primary: false  isArray: false  auto: false  col: int             len: -1      default: [0]
	...
	//[37] promotion_detail                               json                 null: false  primary: false  isArray: false  auto: false  col: json            len: -1      default: []
	PromotionDetail string `gorm:"column:promotion_detail;type:json;" json:"promotion_detail"` // 优惠信息
	//[38] logistics_info                                 json                 null: false  primary: false  isArray: false  auto: false  col: json            len: -1      default: []
	LogisticsInfo string `gorm:"column:logistics_info;type:json;" json:"logistics_info"` // 物流信息
	//[39] yx_product_id                                  ubigint              null: false  primary: false  isArray: false  auto: false  col: ubigint         len: -1      default: [0]
	YxProductID uint64 `gorm:"column:yx_product_id;type:ubigint;default:0;" json:"yx_product_id"` // yx商品id
	//[40] product_id                                     ubigint              null: false  primary: false  isArray: false  auto: false  col: ubigint         len: -1      default: [0]
	ProductID uint64 `gorm:"column:product_id;type:ubigint;default:0;" json:"product_id"` // 商品ID
	//[41] product_name                                   varchar(255)         null: false  primary: false  isArray: false  auto: false  col: varchar         len: 255     default: []
	ProductName string `gorm:"column:product_name;type:varchar;size:255;" json:"product_name"` // 商品名称
	//[42] product_pic                                    varchar(255)         null: false  primary: false  isArray: false  auto: false  col: varchar         len: 255     default: []
	ProductPic string `gorm:"column:product_pic;type:varchar;size:255;" json:"product_pic"` // 头图，商品主图第一张
	//[43] sku_id                                         ubigint              null: false  primary: false  isArray: false  auto: false  col: ubigint         len: -1      default: [0]
	SkuID uint64 `gorm:"column:sku_id;type:ubigint;default:0;" json:"sku_id"` // 商品skuId\n
	//[44] spec                                           json                 null: false  primary: false  isArray: false  auto: false  col: json            len: -1      default: []
	Spec string `gorm:"column:spec;type:json;" json:"spec"` // 规格信息
	//[45] category_list                                  json                 null: false  primary: false  isArray: false  auto: false  col: json            len: -1      default: []
	CategoryList string `gorm:"column:category_list;type:json;" json:"category_list"` // 商品类目
	//[46] origin_amount                                  uint                 null: false  primary: false  isArray: false  auto: false  col: uint            len: -1      default: [0]
	OriginAmount uint32 `gorm:"column:origin_amount;type:uint;default:0;" json:"origin_amount"` // 商品现价
	//[47] item_num                                       int                  null: false  primary: false  isArray: false  auto: false  col: int             len: -1      default: [0]
	ItemNum int32 `gorm:"column:item_num;type:int;default:0;" json:"item_num"` // 商品件数
	//[48] is_comment                                     smallint             null: false  primary: false  isArray: false  auto: false  col: smallint        len: -1      default: [0]
	IsComment int32 `gorm:"column:is_comment;type:smallint;default:0;" json:"is_comment"` // 是否评价 :1已评价，0未评价
	//[49] add_time                                       uint                 null: false  primary: false  isArray: false  auto: false  col: uint            len: -1      default: [0]
	AddTime uint32 `gorm:"column:add_time;type:uint;default:0;" json:"add_time"` // 创建时间
	//[50] last_time                                      uint                 null: false  primary: false  isArray: false  auto: false  col: uint            len: -1      default: [0]
	LastTime uint32 `gorm:"column:last_time;type:uint;default:0;" json:"last_time"` // 修改时间

}

var order_product_dy_tempTableInfo = &TableInfo{
	Name: "order_product_dy_temp",
	Columns: []*ColumnInfo{
...
func (o *OrderProductDyTemp) TableName() string {
	return "order_product_dy_temp"
}

// BeforeSave invoked before saving, return an error if field is not populated.
func (o *OrderProductDyTemp) BeforeSave() error {
	return nil
}

// Prepare invoked before saving, can be used to populate fields etc.
func (o *OrderProductDyTemp) Prepare() {
}

// Validate invoked before performing action, return an error if field is not populated.
func (o *OrderProductDyTemp) Validate(action Action) error {
	return nil
}

// TableInfo return table meta data
func (o *OrderProductDyTemp) TableInfo() *TableInfo {
	return order_product_dy_tempTableInfo
}
