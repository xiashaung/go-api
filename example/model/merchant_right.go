...
CREATE TABLE `merchant_right` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='商家权益表'

JSON Sample
-------------------------------------
{    "id": 85,    "merchant_id": 99,    "right_type": 64,    "right_info": "kXrAMVfVHBPmsmKHqrHoBOUTQ",    "source_type": 15,    "source_desc": "xKkaZswnsTdUpTgJolvyjHFye",    "start_time": 94,    "end_time": 11,    "add_time": 14,    "last_time": 10}
...
// MerchantRight struct is a row record of the merchant_right table in the yx database
type MerchantRight struct {
	//[ 0] id                                             uint                 null: false  primary: true   isArray: false  auto: true   col: uint            len: -1      default: []
	ID uint32 `gorm:"primary_key;AUTO_INCREMENT;column:id;type:uint;" json:"id"`
	//[ 1] merchant_id                                    int                  null: false  primary: false  isArray: false  auto: false  col: int             len: -1      default: []
	MerchantID int32 `gorm:"column:merchant_id;type:int;" json:"merchant_id"` // 商家id
...
var merchant_rightTableInfo = &TableInfo{
	Name: "merchant_right",
	Columns: []*ColumnInfo{
...
func (m *MerchantRight) TableName() string {
	return "merchant_right"
}

// BeforeSave invoked before saving, return an error if field is not populated.
func (m *MerchantRight) BeforeSave() error {
	return nil
}

// Prepare invoked before saving, can be used to populate fields etc.
func (m *MerchantRight) Prepare() {
}

// Validate invoked before performing action, return an error if field is not populated.
func (m *MerchantRight) Validate(action Action) error {
	return nil
}

// TableInfo return table meta data
func (m *MerchantRight) TableInfo() *TableInfo {
	return merchant_rightTableInfo
}
