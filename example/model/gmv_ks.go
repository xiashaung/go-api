...
JSON Sample
-------------------------------------
{    "id": 62,    "order_gmv": 70,    "colonel_gmv": 32,    "date": "2179-05-23T18:34:35.743024549+08:00",    "add_time": 93,    "last_time": 75}
...
// GmvKs struct is a row record of the gmv_ks table in the yx database
type GmvKs struct {
...
func (g *GmvKs) TableName() string {
	return "gmv_ks"
}

// BeforeSave invoked before saving, return an error if field is not populated.
func (g *GmvKs) BeforeSave() error {
	return nil
}

// Prepare invoked before saving, can be used to populate fields etc.
func (g *GmvKs) Prepare() {
}

// Validate invoked before performing action, return an error if field is not populated.
func (g *GmvKs) Validate(action Action) error {
	return nil
}

// TableInfo return table meta data
func (g *GmvKs) TableInfo() *TableInfo {
	return gmv_ksTableInfo
}
