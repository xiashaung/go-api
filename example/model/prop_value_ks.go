...
JSON Sample
-------------------------------------
{    "id": 57,    "prop_id": 13,    "prop_value": "SOpNiRDrjbHRvaMaUKgicEvSe",    "prop_type": 6,    "add_time": 84,    "last_time": 94}
...
// PropValueKs struct is a row record of the prop_value_ks table in the yx database
type PropValueKs struct {
...
var prop_value_ksTableInfo = &TableInfo{
	Name: "prop_value_ks",
	Columns: []*ColumnInfo{
...
func (p *PropValueKs) TableName() string {
	return "prop_value_ks"
}

// BeforeSave invoked before saving, return an error if field is not populated.
func (p *PropValueKs) BeforeSave() error {
	return nil
}

// Prepare invoked before saving, can be used to populate fields etc.
func (p *PropValueKs) Prepare() {
}

// Validate invoked before performing action, return an error if field is not populated.
func (p *PropValueKs) Validate(action Action) error {
	return nil
}

// TableInfo return table meta data
func (p *PropValueKs) TableInfo() *TableInfo {
	return prop_value_ksTableInfo
}
