...
CREATE TABLE `notify_order_ks` (
  ...
  `update_time` bigint(20) NOT NULL DEFAULT '0' COMMENT '修改时间-ks',
...
JSON Sample
-------------------------------------
{    "id": 2,    "event_id": "uFKLDneAfXOrZroEExAopEbqm",    "biz_id": 84,    "user_id": 87,    "open_id": "MIEfnBgOWXvlsINCSHrTfdDUw",    "app_key": "FlIdpDJgWTvIGtTZuHFnryUHQ",    "event": "DlYccShlBaXhfDJLlWZaTZeOr",    "info": "gaRBffvngVpAMLqDTOAPmPqef",    "create_time": 46,    "update_time": 54,    "error_msg": "jTqvhFDCffMvhAXgwQXpPagVd",    "status": 89,    "try_count": 41,    "add_time": 36,    "last_time": 6}
...
// NotifyOrderKs struct is a row record of the notify_order_ks table in the yx database
type NotifyOrderKs struct {
	...
	UpdateTime int64 `gorm:"column:update_time;type:bigint;default:0;" json:"update_time"` // 修改时间-ks
...
var notify_order_ksTableInfo = &TableInfo{
	Name: "notify_order_ks",
	Columns: []*ColumnInfo{
...
func (n *NotifyOrderKs) TableName() string {
	return "notify_order_ks"
}

// BeforeSave invoked before saving, return an error if field is not populated.
func (n *NotifyOrderKs) BeforeSave() error {
	return nil
}

// Prepare invoked before saving, can be used to populate fields etc.
func (n *NotifyOrderKs) Prepare() {
}

// Validate invoked before performing action, return an error if field is not populated.
func (n *NotifyOrderKs) Validate(action Action) error {
	return nil
}

// TableInfo return table meta data
func (n *NotifyOrderKs) TableInfo() *TableInfo {
	return notify_order_ksTableInfo
}
